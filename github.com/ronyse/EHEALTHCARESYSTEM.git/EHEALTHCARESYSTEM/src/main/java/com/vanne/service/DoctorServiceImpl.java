...
public class DoctorServiceImpl implements DoctorService {
	...
	/*
	 * @Override public void save(DoctorUser doctor) {
	 * 
	 * doctor.setPassword(bCryptPasswordEncoder.encode(doctor.getPassword()));
	 * doctor.setActive(2);
	 * 
	 * Role userRole = roledao.findByRoleName("DOCTOR"); doctor.setRoles(new
	 * HashSet<Role>(Arrays.asList(userRole))); doctordao.save(doctor); }
	 */
